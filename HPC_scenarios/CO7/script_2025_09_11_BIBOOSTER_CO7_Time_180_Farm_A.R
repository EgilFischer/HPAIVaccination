# Scenario:BIBOOSTER_CO7_Time_180_Farm_A
 param_list <- list(scenario="BIBOOSTER_CO7_Time_180_Farm_A",
runs=100,
deltat=0.005,
length.round=90,
age_at_d0=180,
N0=46000,
itypes=2,
p.protect=0.621848739495798,
no.introduction=1,
introduction.at.random=TRUE,
intro.time=0,
beta=matrix(c(2.06, 2.06, 0.11, 0.11), ncol = 2),
latency.period=c(1, 1),
k.latency=2,
infectious.period=c(3.68, 3.4),
k.infectious=2,
trans.mean.wane=Inf,
trans.var.wane=Inf,
