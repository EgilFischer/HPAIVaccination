# Scenario:CEVA_CO6_Time_300_Farm_A
 param_list <- list(scenario="CEVA_CO6_Time_300_Farm_A",
runs=100,
deltat=0.005,
length.round=90,
age_at_d0=300,
N0=46000,
itypes=2,
p.protect=0.941666666666667,
no.introduction=1,
introduction.at.random=TRUE,
intro.time=0,
beta=matrix(c(1.92, 1.92, 0.15, 0.15), ncol = 2),
latency.period=c(1, 1),
k.latency=2,
infectious.period=c(4.33, 3.7),
k.infectious=2,
trans.mean.wane=Inf,
trans.var.wane=Inf,
